...
export default function EditQuestion() {
            ...
            try {
                ...
                setFormData({
                    ...
                    testCases: data.testCases.map((tc: any) => ({
                        ...tc,
                        id: tc.id // Use existing ID from DB
                    })),
                });
            } catch (err: any) {
    ...
    const updateTestCase = (id: any, field: string, value: any) => {
        setFormData(prev => ({
            ...prev,
    ...
    return (
        <div className="max-w-4xl mx-auto pb-20">
            <div className="flex items-center justify-between mb-10">
                <div>
                    <h1 className="text-3xl font-black italic tracking-tighter text-gray-950 uppercase">Edit Challenge</h1>
                    <p className="text-gray-400 font-bold italic text-sm mt-1 uppercase tracking-widest">Modifying localized problem matrix</p>
                </div>
